    ...
    return (
        <div className='px-8 mb-10 pt-8'>
            <div className="flex items-center justify-between gap-8 mb-10">
                ...
                <div className="text-xl md:text-2xl font-bold text-center text-gray-700 dark:text-gray-400 uppercase hover:underline">
                    FAQ
                </div>
                <span className="w-1/5 border-b lg:w-3/4"></span>
            </div>
            <div className="flex flex-col lg:flex-row items-center justify-center lg:justify-between gap-8">
                ...
                <div className="lg:w-1/2 w-full text-white ">
                    <div className="collapse collapse-arrow bg-gray-200 dark:bg-gray-800">
                        ...
                        <div className="collapse-content text-gray-700 dark:text-gray-400">
                    ...
                    <div className="collapse collapse-arrow mt-4 bg-gray-200 dark:bg-gray-800">
